    ...
    <div class="box-header">
      ...
      <div class="main-form">
        <form method="POST" action="<?php echo site_url('/wp-admin/admin.php?page=jne-tracing'); ?>">
          <input type="text" placeholder="Enter the note number" name="awb" value="<?php echo $_POST['awb'] ?>"
            class="form-control" />
      ...
      <div class="package-header">
        ...
        <div class="package-detail">
          ...
          <div>
            ...
            <span>
              <?php echo $cnote['cnote_shipper_addr1']; ?>
              <?php echo $cnote['cnote_shipper_addr2']; ?>
              <?php echo $cnote['cnote_shipper_addr3']; ?>
            </span>
          ...
          <div>
            ...
            <span>
              <?php echo $cnote['cnote_receiver_addr1']; ?>
              <?php echo $cnote['cnote_receiver_addr2']; ?>
              <?php echo $cnote['cnote_receiver_addr3']; ?>
            </span>
